...
const GraphicsBooklet = ({
  ...
  return (
    <div className="group relative">
      <p
        className="group-hover:invisible group-hover:opacity-0 font-bold text-xl left-1/2 top-1/2 z-10 absolute"
        style={{
      ...
      <div
        className=" blur-sm hover:blur-0 h-screen flex py-[112px] lg:py-[88px] lg:justify-center"
